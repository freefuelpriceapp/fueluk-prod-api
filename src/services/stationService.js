...
function formatStation(row) {
  ...
  return {
    ...
    petrol_updated_at: row.petrol_updated_at || null,
    diesel_updated_at: row.diesel_updated_at || null,
    e10_updated_at: row.e10_updated_at || null,
    super_unleaded_updated_at: row.super_unleaded_updated_at || null,
    premium_diesel_updated_at: row.premium_diesel_updated_at || null,
